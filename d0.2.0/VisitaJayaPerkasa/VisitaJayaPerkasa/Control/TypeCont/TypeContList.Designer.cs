namespace VisitaJayaPerkasa.Control.TypeCont
{
    partial class TypeContList
    {
        ...
        private void InitializeComponent()
        {
            ...
            gridViewTextBoxColumn15.FieldAlias = "ID";
            gridViewTextBoxColumn15.FieldName = "PersonID";
            gridViewTextBoxColumn15.HeaderText = "ID";
            gridViewTextBoxColumn15.IsVisible = false;
            gridViewTextBoxColumn15.UniqueName = "PersonID";
            gridViewTextBoxColumn16.FieldAlias = "UserName";
            gridViewTextBoxColumn16.FieldName = "UserName";
            gridViewTextBoxColumn16.HeaderText = "User Name";
            gridViewTextBoxColumn16.UniqueName = "UserName";
            gridViewTextBoxColumn16.Width = 80;
            gridViewTextBoxColumn17.FieldAlias = "FirstName";
            gridViewTextBoxColumn17.FieldName = "FirstName";
            gridViewTextBoxColumn17.HeaderText = "First Name";
            gridViewTextBoxColumn17.UniqueName = "FirstName";
            gridViewTextBoxColumn17.Width = 100;
            gridViewTextBoxColumn18.FieldAlias = "LastName";
            gridViewTextBoxColumn18.FieldName = "LastName";
            gridViewTextBoxColumn18.HeaderText = "Last Name";
            gridViewTextBoxColumn18.UniqueName = "LastName";
            gridViewTextBoxColumn18.Width = 100;
            gridViewTextBoxColumn19.FieldAlias = "Email";
            gridViewTextBoxColumn19.FieldName = "Email";
            gridViewTextBoxColumn19.HeaderText = "Email";
            gridViewTextBoxColumn19.UniqueName = "Email";
            gridViewTextBoxColumn19.Width = 120;
            gridViewTextBoxColumn20.FieldAlias = "Address";
            gridViewTextBoxColumn20.FieldName = "Address";
            gridViewTextBoxColumn20.HeaderText = "Address";
            gridViewTextBoxColumn20.UniqueName = "Address";
            gridViewTextBoxColumn20.Width = 150;
            gridViewTextBoxColumn21.FieldAlias = "MobilePhoneNumber";
            gridViewTextBoxColumn21.FieldName = "MobilePhoneNumber";
            gridViewTextBoxColumn21.HeaderText = "Phone Number";
            gridViewTextBoxColumn21.UniqueName = "MobilePhoneNumber";
            gridViewTextBoxColumn21.Width = 120;
            this.PelayaranGridView.MasterGridViewTemplate.Columns.Add(gridViewTextBoxColumn15);
            this.PelayaranGridView.MasterGridViewTemplate.Columns.Add(gridViewTextBoxColumn16);
            this.PelayaranGridView.MasterGridViewTemplate.Columns.Add(gridViewTextBoxColumn17);
            this.PelayaranGridView.MasterGridViewTemplate.Columns.Add(gridViewTextBoxColumn18);
            this.PelayaranGridView.MasterGridViewTemplate.Columns.Add(gridViewTextBoxColumn19);
            this.PelayaranGridView.MasterGridViewTemplate.Columns.Add(gridViewTextBoxColumn20);
            this.PelayaranGridView.MasterGridViewTemplate.Columns.Add(gridViewTextBoxColumn21);
            ...
            this.PelayaranGridView.Size = new System.Drawing.Size(627, 242);
            this.PelayaranGridView.TabIndex = 9;
